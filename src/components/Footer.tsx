    ...
    <footer className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">L'enfant Roi Nursery</h3>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/roi_lenfant/?igsh=MzF4MzFrZmRycGhx#"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/20 hover:bg-white/30 p-3 rounded-full transition-all duration-300 hover:scale-110"
              >
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="text-white/80">
            © 2025 L'enfant Roi Nursery & Preschool. All rights reserved. | Created By <a href="https://zedlink.netlify.app/"> | <span className="font-bold text-x0.6">ZED-LINK Solution.</span></a>
          </p>
        </div>
      </div>
    </footer>
